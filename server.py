            ...
            "tools": [  # Define the tools (functions) the AI can use
                        {
                            ...
                            "description": "Massage envy has more 1000 franchised locations in US. Using find_nearest_location function search 1 Massege Envy locate near user's address. Input: user's address",
                            "parameters": {
                                "type": "object",
                                "properties": {
                                    "address": { 
